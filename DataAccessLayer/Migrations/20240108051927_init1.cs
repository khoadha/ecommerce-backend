        ...
        { Guid.NewGuid().ToString(), "Manager", "MANAGER", Guid.NewGuid().ToString() },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagedStoreId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Stores_ManagedStoreId",
                        column: x => x.ManagedStoreId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ManagedStoreId",
                table: "AspNetUsers",
                column: "ManagedStoreId",
                unique: true,
                filter: "[ManagedStoreId] IS NOT NULL");
